...
/**********************************************************************************/
/*                         SliderTrackBar - Version  1.3                          */
/**********************************************************************************/
/* http://www.codeproject.com/Articles/997101/Custom-Slider-Style-TrackBar-Slider */
/**********************************************************************************/

namespace Tools4Libraries.Slider
{
    [DefaultValue("Value"), DefaultEvent("ValueChanged"), ToolboxBitmap(typeof(TrackBar))]
    public class SliderTrackBar : Control
    {
        ...
        public SliderTrackBar()
        {
            ...
            _renderer = new HorizontalSliderTrackBarRenderer(this);
        ...
        public enum SliderTrackBarShowSlider
        {
            Never,
            OnHover,
            Always
        ...
        public enum SliderTrackBarTrackStyle
        {
            None,
            FromZero,
            FromLeftOrTop,
        ...
        public enum SliderTrackBarScaleFieldPosition
        {
            LeftOrTop,
            RightOrBottom
        }

        public enum SliderTrackBarTickPosition
        {
            LeftOrTop,
            RightOrBottom,
            Both
        ...
        public enum SliderTrackBarTickAlignment
        {
            Near,
            Center,
            Far
        ...
        public enum SliderTrackBarKeyChangeOption
        {
            NoKeyChange,
        ...
        public enum SliderTrackBarValueChangeSource
        {
            Code,
            SliderChange,
            TrackClick,
        ...
        public enum SliderTrackBarScaleType
        {
            None,
            ScaleFields,
            Ticks
        ...
        public delegate void ValueChangingDelegate(Object sender, SliderTrackBarValueChangingEventArgs e);
        [Description("Raised before the TrackBar Value property changes")]
        public event ValueChangingDelegate ValueChanging;

        public delegate void ValueChangedDelegate(Object sender, SliderTrackBarValueChangedEventArgs e);
        ...
        public delegate void SeekingDelegate(Object sender, SliderTrackBarSeekEventArgs e);
        [Description("Raised when the TrackBar is seeking.")]
        public event SeekingDelegate Seeking;

        public delegate void SeekDoneDelegate(Object sender, SliderTrackBarSeekEventArgs e);
        ...
        private SliderTrackBarRenderer _renderer;
        ...
        private SliderTrackBarShowSlider _showSlider = SliderTrackBarShowSlider.Always;
        private int _seekSliderTransparency = 200;
        private bool _useHoverEffect = true;

        private SliderTrackBarKeyChangeOption _keyChangeOption = SliderTrackBarKeyChangeOption.UpAndDownArrowKeys;
        private int _smallChange = 3;
        private int _largeChange = 10;
        private bool _allowMouseWheelChange = true;

        private SliderTrackBarScaleType _scaleType = SliderTrackBarScaleType.ScaleFields;

        private SliderTrackBarTickPosition _tickPosition = SliderTrackBarTickPosition.Both;
        private int _tickSpacing = 1;
        private int _tickWidth = 1;
        private int _tickHeight = 1;
        private int _tickEmphasizedHeight = 3;
        private SliderTrackBarTickAlignment _tickAlignment = SliderTrackBarTickAlignment.Center;
        ...
        private SliderTrackBarScaleFieldPosition _scaleFieldPosition = SliderTrackBarScaleFieldPosition.LeftOrTop;
        ...
        private SliderTrackBarTrackStyle _trackStyle = SliderTrackBarTrackStyle.FromZero;
        ...
        internal int SeekValue
        {
            ...
            private set
            {
                ...
                if (Seeking != null)
                {
                    SliderTrackBarSeekEventArgs eargs = new SliderTrackBarSeekEventArgs(_seekValue);
                    Seeking(this, eargs);
                }
            }
        }
        ...
        internal bool IsSliderVisible
        {
            get
            {
                switch (_showSlider)
                {
                    case SliderTrackBarShowSlider.Always:
                        return true;
                    case SliderTrackBarShowSlider.Never:
                        return false;
                    case SliderTrackBarShowSlider.OnHover:
            ...
            set
            {
                if (_showSlider != SliderTrackBarShowSlider.Never)
                {
                    Invalidate();
                }
            }
        ...
        public int Value
        {
            ...
            set
            {
                if (value != _value)
                {
                    ...
                    {
                        SliderTrackBarValueChangingEventArgs args = new SliderTrackBarValueChangingEventArgs(value, SliderTrackBarValueChangeSource.Code);
                    ...
                    if (ValueChanged != null)
                        ValueChanged(this, new SliderTrackBarValueChangedEventArgs(_value, SliderTrackBarValueChangeSource.Code));
                }
            }
        }
                ...
                if (value != _orientation)
                {
                    ...
                    switch (_orientation)
                    {
                        ...
                        case Orientation.Vertical:
                            _renderer = new VerticalSliderTrackBarRenderer(this);
                            break;
                    }    
                }
        ...
        [Bindable(false)]
        [DefaultValue(typeof(SliderTrackBarTrackStyle), "FromZero")]
        [Category("Behavior")]
        [Description("Gets or sets how the TrackBar track should be filled")]
        public SliderTrackBarTrackStyle TrackStyle
        {
        ...
        [Bindable(false)]
        [DefaultValue(typeof(SliderTrackBarScaleType), "ScaleFields")]
        [Category("Appearance")]
        [Description("Gets or sets the TrackBar scale type")]
        public SliderTrackBarScaleType ScaleType
        {
        ...
        [Bindable(false)]
        [DefaultValue(typeof(SliderTrackBarTickPosition), "Both")]
        [Category("Appearance")]
        [Description("Gets or sets the position of the TrackBar ticks")]
        public SliderTrackBarTickPosition TickPosition
        {
        ...
        [Bindable(false)]
        [DefaultValue(typeof(SliderTrackBarTickAlignment), "Center")]
        [Category("Appearance")]
        [Description("Gets or sets the alignment of the TrackBar ticks")]
        public SliderTrackBarTickAlignment TickAlignment
        {
        ...
        [Bindable(false)]
        [DefaultValue(typeof(SliderTrackBarScaleFieldPosition), "LeftOrTop")]
        [Category("Appearance")]
        [Description("Gets or sets the position of the TrackBar scale fields")]
        public SliderTrackBarScaleFieldPosition ScaleFieldPosition
        {
        ...
        [Bindable(false)]
        [DefaultValue(typeof(SliderTrackBarShowSlider), "Always")]
        [Category("Behavior")]
        [Description("Gets or sets When the slider should be shown")]
        public SliderTrackBarShowSlider ShowSlider
        {
        ...
        [Bindable(false)]
        [DefaultValue(typeof(SliderTrackBarKeyChangeOption), "UpAndDownArrowKeys")]
        [Category("Behavior")]
        [Description("Gets or sets if the user should be able to change the trackbar value using the arrow keys")]
        public SliderTrackBarKeyChangeOption KeyChangeOption
        {
        ...
        private void SetValueInternal(int value, bool raiseScroll, SliderTrackBarValueChangeSource source)
        {
            if (value > Maximum)
                value = Maximum;
            ...
            if (ValueChanging != null)
            {
                SliderTrackBarValueChangingEventArgs args = new SliderTrackBarValueChangingEventArgs(value, source);
                ValueChanging(this, args);
            ...
            if (ValueChanged != null)
                ValueChanged(this, new SliderTrackBarValueChangedEventArgs(_value, source));
        }
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (IsSeeking)
            {
                ...
                if (UseSeeking)
                    ...
                    SetValueInternal(currentValue, true, SliderTrackBarValueChangeSource.SliderChange);
            }
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            else if (clickRectangle.Contains(e.Location))
            {
                ...
                SetValueInternal(currentValue, true, SliderTrackBarValueChangeSource.TrackClick);
            }
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            {
                SetValueInternal(SeekValue, true, SliderTrackBarValueChangeSource.SliderChange);

                if (SeekDone != null)
                    SeekDone(this, new SliderTrackBarSeekEventArgs(SeekValue));
            }
        ...
        protected override void OnMouseWheel(MouseEventArgs e)
        {
            ...
            if (e.Delta > 0)
                SetValueInternal(Value + SmallChange, true, SliderTrackBarValueChangeSource.MouseWheel);
        ...
        {
            if (!AllowUserValueChange || _keyChangeOption == SliderTrackBarKeyChangeOption.NoKeyChange)
                return;

            if (_keyChangeOption == SliderTrackBarKeyChangeOption.LeftAndRightArrowKeys)
            {
                if (e.KeyCode == Keys.Left)
                {
                    SetValueInternal(Value - SmallChange, false, SliderTrackBarValueChangeSource.KeyPress);
                }
            ...
            {
                SetValueInternal(Value + LargeChange, false, SliderTrackBarValueChangeSource.KeyPress);
            }
            ...
            {
                SetValueInternal(Maximum, false, SliderTrackBarValueChangeSource.KeyPress);
            }
            else if (e.KeyCode == Keys.End)
            {
                SetValueInternal(Minimum, false, SliderTrackBarValueChangeSource.KeyPress);
            }
