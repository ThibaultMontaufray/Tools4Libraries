...
{
    public abstract class SliderTrackBarRenderer
    {
        ...
        public void RenderControl(PaintEventArgs e)
        {
            ...
            {
                if (_trackBar.TickPosition == SliderTrackBar.SliderTrackBarTickPosition.LeftOrTop ||
                    _trackBar.TickPosition == SliderTrackBar.SliderTrackBarTickPosition.Both)
                {
                    Rectangle tickRectangle = GetTickLayoutRectangle(SliderTrackBar.SliderTrackBarTickPosition.LeftOrTop);

                    if (tickRectangle != Rectangle.Empty)
                    {
                        e.Graphics.SetClip(tickRectangle);
                        RenderTicks(e.Graphics, SliderTrackBar.SliderTrackBarTickPosition.LeftOrTop);
                        e.Graphics.ResetClip();
                    }
                }

                if (_trackBar.TickPosition == SliderTrackBar.SliderTrackBarTickPosition.RightOrBottom ||
                    _trackBar.TickPosition == SliderTrackBar.SliderTrackBarTickPosition.Both)
                {
                    Rectangle tickRectangle = GetTickLayoutRectangle(SliderTrackBar.SliderTrackBarTickPosition.RightOrBottom);

                    if (tickRectangle != Rectangle.Empty)
                    {
                        e.Graphics.SetClip(tickRectangle);
                        RenderTicks(e.Graphics, SliderTrackBar.SliderTrackBarTickPosition.RightOrBottom);
                        e.Graphics.ResetClip();
                    }
                }
            }
        ...
        public abstract Rectangle GetTickLayoutRectangle(SliderTrackBar.SliderTrackBarTickPosition position);
        public abstract void RenderTicks(Graphics g, SliderTrackBar.SliderTrackBarTickPosition position);
