...
{
    public class HorizontalSliderTrackBarRenderer : SliderTrackBarRenderer
    {
        ...
        public override void RenderTrack(Graphics g)
        {
            ...
            if (_trackBar.TrackStyle != SliderTrackBar.SliderTrackBarTrackStyle.None)
            {
                ...
                if (_trackBar.TrackStyle == SliderTrackBar.SliderTrackBarTrackStyle.FromLeftOrTop || (_trackBar.TrackStyle == SliderTrackBar.SliderTrackBarTrackStyle.FromZero && _trackBar.Minimum == 0))
                {
                    startPixel = 2;
                    endPixel = ValueToPixelValue(_trackBar.Value);
                }
                else if (_trackBar.TrackStyle == SliderTrackBar.SliderTrackBarTrackStyle.FromRightOrBottom || (_trackBar.TrackStyle == SliderTrackBar.SliderTrackBarTrackStyle.FromZero && _trackBar.Maximum == 0))
                {
